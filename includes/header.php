...
<div id="wrapper_sec">
	<div id="masthead">
    	<div class="logo">
        	<a href="./index.php" class="logo-custom" " >FRESHFARM</a>
        </div>
            ...
            <div class="navigation">
            	<div id="smoothmenu1" class="ddsmoothmenu">
					...
					<?php if($_SESSION['login'] != 1) {?>
						<li><a href="./product-listing.php">All Fruits and Vegetables</a></li>
						<li><a href="./company-listing.php">All Category</a></li>
					...
					<?php if($_SESSION['user_details']['user_level_id'] == 2) {?>
						...
						<li><a href="#">Fruits And Vegetables</a>
							<ul>
								<li><a href="./product-listing.php">All Fruits And Vegetables</a></li>
								<li><a href="./company-listing.php">All Category</a></li>
								<li><a href="./type-listing.php">All Types</a></li>
